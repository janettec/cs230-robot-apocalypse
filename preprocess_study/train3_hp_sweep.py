...
tf.app.flags.DEFINE_string('source_vocabulary', 'data/all.clean.anno.json', 'Path to source vocabulary')
tf.app.flags.DEFINE_string('target_vocabulary', 'data/all.clean.code.json', 'Path to target vocabulary')
tf.app.flags.DEFINE_string('source_train_data', 'data/train_small.clean.anno', 'Path to source training data')
tf.app.flags.DEFINE_string('target_train_data', 'data/train_small.clean.code', 'Path to target training data')
tf.app.flags.DEFINE_string('source_valid_data', 'data/train_small.bpe.anno', 'Path to source validation data')
tf.app.flags.DEFINE_string('target_valid_data', 'data/train_small.bpe.code', 'Path to target validation data')
