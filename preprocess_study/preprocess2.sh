...
echo "shuffling.."
python2 shuffle.py ${CORPUS}.${S} ${CORPUS}.${T}
mv ${CORPUS}.${S}.shuf ${CORPUS}.orig.shuf.${S}
mv ${CORPUS}.${T}.shuf ${CORPUS}.orig.shuf.${T}

python2 shuffle.py ${CORPUS}.clean.${S} ${CORPUS}.clean.${T}
...
python2 data_statistics.py ${CORPUS}.clean.${S} ${CORPUS}.clean.${T}
