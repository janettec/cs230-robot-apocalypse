...
tf.app.flags.DEFINE_string('source_vocabulary', 'data/all.tok.anno.json', 'Path to source vocabulary')
tf.app.flags.DEFINE_string('target_vocabulary', 'data/all.tok.code.json', 'Path to target vocabulary')
tf.app.flags.DEFINE_string('source_train_data', 'data/train.tok.anno', 'Path to source training data')
tf.app.flags.DEFINE_string('target_train_data', 'data/train.tok.code', 'Path to target training data')
