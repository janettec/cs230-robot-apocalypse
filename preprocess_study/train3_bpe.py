...
tf.app.flags.DEFINE_string('source_train_data', 'data/train.clean.anno', 'Path to source training data')
tf.app.flags.DEFINE_string('target_train_data', 'data/train.clean.code', 'Path to target training data')
