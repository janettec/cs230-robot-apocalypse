...
tf.app.flags.DEFINE_string('source_train_data', 'data/train_small.anno', 'Path to source training data')
tf.app.flags.DEFINE_string('target_train_data', 'data/train_small.code', 'Path to target training data')
