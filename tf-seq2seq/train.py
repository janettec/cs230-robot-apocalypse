...
tf.app.flags.DEFINE_string('source_train_data', 'data/all.anno', 'Path to source training data')
tf.app.flags.DEFINE_string('target_train_data', 'data/all.code', 'Path to target training data')
tf.app.flags.DEFINE_string('source_valid_data', 'data/all.bpe.anno', 'Path to source validation data')
tf.app.flags.DEFINE_string('target_valid_data', 'data/all.bpe.code', 'Path to target validation data')
