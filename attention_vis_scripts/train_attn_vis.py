...
from seq2seq_model_attn_vis import Seq2SeqModel


# Data loading parameters
tf.app.flags.DEFINE_string('source_vocabulary', 'data/all.shuf.anno.json', 'Path to source vocabulary')
tf.app.flags.DEFINE_string('target_vocabulary', 'data/all.shuf.code.json', 'Path to target vocabulary')
tf.app.flags.DEFINE_string('source_train_data', 'data/train.shuf.anno', 'Path to source training data')
tf.app.flags.DEFINE_string('target_train_data', 'data/train.shuf.code', 'Path to target training data')
tf.app.flags.DEFINE_string('source_valid_data', 'data/train.bpe.anno', 'Path to source validation data')
tf.app.flags.DEFINE_string('target_valid_data', 'data/train.bpe.code', 'Path to target validation data')
