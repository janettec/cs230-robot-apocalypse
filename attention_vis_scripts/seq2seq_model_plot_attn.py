...
class Seq2SeqModel(object):
    ...
    def plot_attention(self,attention_map):
        attention_map = attention_map[0:attention_map.shape[0]-1,:]
        ...
        ax.grid()
        plt.savefig('/home/jskarda/tf-seq2seq/output_full_useShuf_attnVis/attn_vis_plots/attn_'+str(self.attn_ex)+'.png')
